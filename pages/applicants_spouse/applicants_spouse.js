...
const state = {
  entity: "applicants_spouse",
  attributes: ["app_fname", "app_mname", "app_lname", "app_age" , "app_dob" , "app_smarried" , "app_religion" , "app_nickname" , "app_pres_address" , "app_paddress" , "app_haddress" , "app_bplace" , "app_nodc" , "app_ohl" , "app_lor" , "app_ohrl" , "app_oname" , "app_loresidences" , "app_cnumber" , "app_firm" , "app_address" , "app_position" , "app_salary" , "app_loservices" , "app_bname" , "app_baddress" , "app_lobusiness" , "app_swo" , "app_capital" , "app_nincome" , "app_oincome"],
  model: [],
  activeIndex: 0,
