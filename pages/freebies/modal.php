    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="rolesForm" action="roles/rolesCrudFunction.php">
            <input type="text" name="fb_id" id="fb_id">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="fb_package_name" name="fb_package_name" id="role_display_name" aria-describedby="emailHelp" placeholder="Display Name" style="background-color:gray;">
            </div>
            <div class="mb-3">
                <label class="form-label">fb_description</label>
                <input type="text" class="form-control" id="fb_description" name="fb_description" id="role_display_name" aria-describedby="emailHelp" placeholder="Display Name" style="background-color:gray;">
            </div>
